...
export default function ShoppingCartIcon({ productsInCart }) {
  ...
  return (
    <div onClick={GoToCheckout} style={{ display: 'flex', position: 'relative', width: '50px', height: '45px', cursor: 'pointer' }}>
      <svg
